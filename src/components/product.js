...
import { ChevronLeft, ChevronRight, CloudDownload, Heart, Share } from 'lucide-react'
      ...
      <div className="mb-9 pt-4 md:px-6 md:pt-7 lg:mb-2 lg:p-8 2xl:p-10 2xl:pt-10">
        <div className="items-start justify-between lg:flex lg:space-x-8">
          ...
          <div className="flex shrink-0 flex-col lg:w-[430px] xl:w-[470px] 2xl:w-[480px]">
            <div className="pb-5">
            <p className='text-lg font-semibold md:text-xl xl:text-2x'>{title}</p>
              <h2 className="text-lg font-semibold md:text-xl xl:text-2xl">{price}</h2>
            ...
            <div className="space-y-2.5 pt-1.5 md:space-y-3.5 lg:pt-3 xl:pt-4">
              <Link
                href={`/cart?product=${title}&image=${image}&price=${price}`}
